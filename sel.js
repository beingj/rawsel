...
class SelRecord {
    constructor(raw) {
        ...
        this.sensor_type = (a[6] < IPMI_Spec.sensor_type_codes.length) ? Object.keys(IPMI_Spec.sensor_type_codes[a[6]])[0] : 'undefined';
    ...
    event_of(n, offset, sensor_type) {
        ...
        if (n == 0x6f) {
            if (sensor_type >= IPMI_Spec.sensor_type_codes.length) {
                return 'undefined';
            }
    ...
    generic_event_of(n, offset) {
        if ((n == 0) || (n >= IPMI_Spec.generic_event_type_codes.length)) {
            return 'undefined';
        }
    ...
    sensor_event_of(n, offset) {
        if ((n <= 4) || (n >= IPMI_Spec.sensor_type_codes.length)) {
            return 'undefined';
        }
